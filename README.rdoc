...
Trendr has the answers. Travel the Globe and see the top, trending media in many countries. 
...
If nothing seems to be working look at your browser's address bar.  
See any strange warnings or icons?  Your browser may be blocking some scripts do to security concerns.
